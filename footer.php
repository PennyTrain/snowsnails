...
<form id="subscribe" class="text" method="post" action="/dab502/assignment/snowsnail/users/user_control.php">
...
<?php elseif (!$isLoggedIn): ?>
    ...
    <section class="exclusive">
        ...
        <button class="mailing-list" onclick="window.location.href='/dab502/assignment/snowsnail/users/user_create.php'">
            Register
        </button>
    </section>
...
<?php endif; ?>
    ...
    <script src="/dab502/assignment/snowsnail/assets/js/script.js"></script>
